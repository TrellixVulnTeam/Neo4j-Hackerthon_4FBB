...
class Model {
    ...
    create({ input, selectionSet, args = {}, context = {}, rootValue = null, } = {}) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const mutationName = `create${upper_case_first_1.upperCaseFirst(this.namePluralized)}`;
            let selection = "";
            if (selectionSet) {
    ...
    update({ where, update, connect, disconnect, create, selectionSet, args = {}, context = {}, rootValue = null, } = {}) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const mutationName = `update${upper_case_first_1.upperCaseFirst(this.namePluralized)}`;
            let selection = "";
            if (selectionSet) {
                selection = printSelectionSet(selectionSet);
            }
    ...
    delete({ where, delete: deleteInput, context = {}, rootValue = null, } = {}) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const mutationName = `delete${upper_case_first_1.upperCaseFirst(this.namePluralized)}`;
